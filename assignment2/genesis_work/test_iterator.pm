...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/ir.stanford.edu/users/r/p/rprabala/EE271/assignment/assignment2/rtl/test_iterator.vp');
# START USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/EE271/assignment/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/ir.stanford.edu/users/r/p/rprabala/EE271/assignment/assignment2/rtl/test_iterator.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // box arranged: [width] box[low(0)or high(1)][x(0) or y(1)] ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // use the helper signals to get status of sample';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic ['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:0] convert;';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '      4\'b0001: convert = '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 8;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      4\'b0010: convert = '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 4;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      4\'b0100: convert = '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 2;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      4\'b1000: convert = '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ';';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      default: convert = 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] step_size = '; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '\'b1 << convert;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] step_size = 1\'b1;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // concatenate next y step and left most of bounding box';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assign next_up_samp_R14S = { sample_R14S[1]+step_size, box_R14S[0][0]};';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // concatenate next x step and current y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assign next_rt_samp_R14S = { sample_R14S[1], sample_R14S[0] + step_size};';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '	   next_sample_R14S[0]    = validPoly_R13H ? box_R13S[0][0] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_sample_R14S[1]    = validPoly_R13H ? box_R13S[0][1] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_validSamp_R14H = validPoly_R13H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_isQuad_R14H    = validPoly_R13H ? isQuad_R13H : 0;   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_state_R14H     = validPoly_R13H ? TEST_STATE : WAIT_STATE;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // first vertex';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_poly_R14S[0][0]      = validPoly_R13H ? poly_R13S[0][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[0][1]      = validPoly_R13H ? poly_R13S[0][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[0][2]      = validPoly_R13H ? poly_R13S[0][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // second ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][0]      = validPoly_R13H ? poly_R13S[1][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][1]      = validPoly_R13H ? poly_R13S[1][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][2]      = validPoly_R13H ? poly_R13S[1][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // third';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][0]      = validPoly_R13H ? poly_R13S[2][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][1]      = validPoly_R13H ? poly_R13S[2][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][2]      = validPoly_R13H ? poly_R13S[2][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_color_R14U[0]    = validPoly_R13H ? color_R13U[0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_color_R14U[1]    = validPoly_R13H ? color_R13U[1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_color_R14U[2]    = validPoly_R13H ? color_R13U[2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_box_R14S[0][0]    = validPoly_R13H ? box_R13S[0][0] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[0][1]    = validPoly_R13H ? box_R13S[0][1] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[1][0]    = validPoly_R13H ? box_R13S[1][0] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[1][1]    = validPoly_R13H ? box_R13S[1][1] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_halt_RnnnnL    = validPoly_R13H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	( TEST_STATE ): begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_sample_R14S[0]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[0] : next_rt_samp_R14S[0]) : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_sample_R14S[1]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[1] : next_rt_samp_R14S[1]) : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_validSamp_R14H = !at_end_box_R14H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_isQuad_R14H    = at_end_box_R14H ? 0 : isQuad_R14H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_state_R14H     = at_end_box_R14H ? WAIT_STATE : TEST_STATE;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   // first vertex';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[0][0]      = !at_end_box_R14H ? poly_R14S[0][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[0][1]      = !at_end_box_R14H ? poly_R14S[0][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[0][2]      = !at_end_box_R14H ? poly_R14S[0][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // second ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][0]      = !at_end_box_R14H ? poly_R14S[1][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][1]      = !at_end_box_R14H ? poly_R14S[1][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[1][2]      = !at_end_box_R14H ? poly_R14S[1][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // third';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][0]      = !at_end_box_R14H ? poly_R14S[2][0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][1]      = !at_end_box_R14H ? poly_R14S[2][1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S[2][2]      = !at_end_box_R14H ? poly_R14S[2][2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_color_R14U[0]    = !at_end_box_R14H  ? color_R14U[0] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_color_R14U[1]    = !at_end_box_R14H  ? color_R14U[1] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_color_R14U[2]    = !at_end_box_R14H  ? color_R14U[2] : 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[0][0]    = !at_end_box_R14H ? box_R14S[0][0] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[0][1]    = !at_end_box_R14H ? box_R14S[0][1] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[1][0]    = !at_end_box_R14H ? box_R14S[1][0] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S[1][1]    = !at_end_box_R14H ? box_R14S[1][1] : 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/EE271/assignment/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE
