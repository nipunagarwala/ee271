...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/tree_hash.vp');
# START USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/tree_hash.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/tree_hash.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/tree_hash.vp PARSED INTO PACKAGE
