...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/sampletest.vp');
# START USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/sampletest.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/sampletest.vp"
...
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $MRound; print { $self->{OutfileHandle} } '-1:0] 	 dist_lg_R16S['; print { $self->{OutfileHandle} } $edges; print { $self->{OutfileHandle} } '-1:0];';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/sampletest.vp PARSED INTO PACKAGE
