...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/bbox.vp');
# START USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/bbox.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/bbox.vp"
...
print { $self->{OutfileHandle} } '    logic frontfacing;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // output for retiming registers';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    # if( $verts == 4 ) {
...
print { $self->{OutfileHandle} } '   //    frontfacing = ((poly_R10S[1][0] - poly_R10S[0][0])*(poly_R10S[2][1] - poly_R10S[1][1]) -';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //    (poly_R10S[2][0] - poly_R10S[1][0])*(poly_R10S[1][1] - poly_R10S[0][1]) <= 0);';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '//    logic [1:0] encode_subSample;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//    assign encode_subSample = {subSample_RnnnnU[3] | subSample_RnnnnU[2], subSample_RnnnnU[3] | subSample_RnnnnU[1]};';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//       rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:'; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-3]  = (box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:'; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-3] >> encode_subSample) << encode_subSample;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '// end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      // Use mask instead of case statement';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     //  rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } '] ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // = box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } '] & ~( (subSample_RnnnnU << ('; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-3)) -1);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     // OLD CODE----';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' //      //Fractional Portion LL less than Subsample set to 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' // //      rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:0] ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // // = box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:0] & ~( (subSample_RnnnnU << ('; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-3)) -1);;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //Integer Portion of LL Remains the Same ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:'; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '] ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     = box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:'; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '];';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assign  outvalid_R10H = ~( | invalidate_R10H ) & validPoly_R10H;// & frontfacing;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/bbox.vp PARSED INTO PACKAGE
