...
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[1] = sample_R14S[1] + (subSample_RnnnnU << ('; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 3));';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[0] = sample_R14S[0] + (subSample_RnnnnU << ('; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 3));';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[1] = sample_R14S[1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
