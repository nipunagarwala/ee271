...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/ir.stanford.edu/users/n/i/nipuna1/ee271/ee271_final_project/assignment/assignment2/rtl/test_iterator.vp');
# START USER CODE FROM /afs/ir.stanford.edu/users/n/i/nipuna1/ee271/ee271_final_project/assignment/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/ir.stanford.edu/users/n/i/nipuna1/ee271/ee271_final_project/assignment/assignment2/rtl/test_iterator.vp"
...
print { $self->{OutfileHandle} } '//   integer [23:0] convert;';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '      4\'b0001: begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[1] = sample_R14S[1] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 3);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[0] = sample_R14S[0] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 3);';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '      4\'b0010: begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[1] = sample_R14S[1] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 2);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[0] = sample_R14S[0] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 2);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[1] = sample_R14S[1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      4\'b0100: begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[1] = sample_R14S[1] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 1);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[0] = sample_R14S[0] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ' - 1);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[1] = sample_R14S[1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      4\'b1000: begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[1] = sample_R14S[1] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ');';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[0] = sample_R14S[0] + (1 << '; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } ');';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_rt_samp_R14S[1] = sample_R14S[1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //next_up_samp_R14S[1] = sample_R14S[1] + (1 << convert);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //next_rt_samp_R14S[0] = sample_R14S[0] + (1 << convert);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //next_rt_samp_R14S[1] = sample_R14S[1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      at_top_edg_R14H = (sample_R14S[1] == box_R14S[1][1]);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      at_right_edg_R14H = (sample_R14S[0] == box_R14S[1][0]);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      at_end_box_R14H = at_top_edg_R14H && at_right_edg_R14H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   // logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] step_size = 24\'b1 << 10;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // concatenate next y step and left most of bounding box';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//   assign next_up_samp_R14S[1] = sample_R14S[1]+step_size   ;//+(24\'b1 << 12); ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//   assign next_up_samp_R14S[0] = box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // concatenate next x step and current y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//   assign next_rt_samp_R14S[0] = sample_R14S[0]+step_size   ;// + (24\'b1 << 12);';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '//   assign next_rt_samp_R14S[1] = sample_R14S[1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //////';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '	   next_sample_R14S[0]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[0] : next_rt_samp_R14S[0]) : box_R14S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_sample_R14S[1]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[1] : next_rt_samp_R14S[1]) : box_R14S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	   next_halt_RnnnnL    = at_end_box_R14H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	end      ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ( TEST_STATE ): begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_sample_R14S[0]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[0] : next_rt_samp_R14S[0]) : box_R13S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_sample_R14S[1]    = !at_end_box_R14H ? (at_right_edg_R14H ? next_up_samp_R14S[1] : next_rt_samp_R14S[1]) : box_R13S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_validSamp_R14H = !at_end_box_R14H || (validPoly_R13H ); ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_isQuad_R14H    = !at_end_box_R14H ? isQuad_R14H : isQuad_R13H;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_state_R14H     = at_end_box_R14H && !validPoly_R13H ? WAIT_STATE : TEST_STATE;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_poly_R14S = !at_end_box_R14H ? poly_R14S : poly_R13S;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_color_R14U = !at_end_box_R14H ? color_R14U : color_R13U; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_box_R14S = !at_end_box_R14H ? box_R14S : box_R13S; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      next_halt_RnnnnL    = at_end_box_R14H || !validPoly_R13H  ;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end      ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      endcase // case ( state_R14H )';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/ir.stanford.edu/users/n/i/nipuna1/ee271/ee271_final_project/assignment/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE
