...
//	
//
//  Source file: /afs/ir.stanford.edu/users/r/p/rprabala/ee271/assignment/assignment2/rtl/bbox.vp
...
module bbox_unq1
  (
   ...
   // always_comb begin
   //    frontfacing = ((poly_R10S[1][0] - poly_R10S[0][0])*(poly_R10S[2][1] - poly_R10S[1][1]) -
   //    (poly_R10S[2][0] - poly_R10S[1][0])*(poly_R10S[1][1] - poly_R10S[0][1]) <= 0);
   // end
...
//    logic [1:0] encode_subSample;
//    assign encode_subSample = {subSample_RnnnnU[3] | subSample_RnnnnU[2], subSample_RnnnnU[3] | subSample_RnnnnU[1]};
...
//       rounded_box_R10S[0][0][10-1:10-3]  = (box_R10S[0][0][10-1:10-3] >> encode_subSample) << encode_subSample;

// end
   always_comb begin
      
      // Use mask instead of case statement
     //  rounded_box_R10S[0][0] 
     // = box_R10S[0][0] & ~( (subSample_RnnnnU << (10-3)) -1);
     
     // OLD CODE----


 //      //Fractional Portion LL less than Subsample set to 0
 // //      rounded_box_R10S[0][0][10-1:0] 
   // // = box_R10S[0][0][10-1:0] & ~( (subSample_RnnnnU << (10-3)) -1);;
...
//       rounded_box_R10S[0][1][10-1:10-3]  = (box_R10S[0][1][10-1:10-3] >> encode_subSample) << encode_subSample;
...
// end
   always_comb begin
     ...
     // = box_R10S[0][1] & ~( (subSample_RnnnnU << (10-3)) -1);
     
     // OLD CODE----


 //      //Fractional Portion LL less than Subsample set to 0
 // //      rounded_box_R10S[0][1][10-1:0] 
   // // = box_R10S[0][1][10-1:0] & ~( (subSample_RnnnnU << (10-3)) -1);;
...
//       rounded_box_R10S[1][0][10-1:10-3]  = (box_R10S[1][0][10-1:10-3] >> encode_subSample) << encode_subSample;
...
// end
   always_comb begin
     ...
     // = box_R10S[1][0] & ~( (subSample_RnnnnU << (10-3)) -1);
     
     // OLD CODE----


 //      //Fractional Portion LL less than Subsample set to 0
 // //      rounded_box_R10S[1][0][10-1:0] 
   // // = box_R10S[1][0][10-1:0] & ~( (subSample_RnnnnU << (10-3)) -1);;
...
//       rounded_box_R10S[1][1][10-1:10-3]  = (box_R10S[1][1][10-1:10-3] >> encode_subSample) << encode_subSample;
...
// end
   always_comb begin
     ...
     // = box_R10S[1][1] & ~( (subSample_RnnnnU << (10-3)) -1);
     
     // OLD CODE----


 //      //Fractional Portion LL less than Subsample set to 0
 // //      rounded_box_R10S[1][1][10-1:0] 
   // // = box_R10S[1][1][10-1:0] & ~( (subSample_RnnnnU << (10-3)) -1);;
   ...
   assign  outvalid_R10H = ~( | invalidate_R10H ) & validPoly_R10H;// & frontfacing;
