...
# DVE full session
# Saved on Fri Feb 19 10:55:39 2016
# Designs open: 0
...
#<Session mode="Full" path="/afs/ir.stanford.edu/users/r/p/rprabala/EE271/assignment/assignment2/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{21 67} {738 774}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 173} {height 388} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 388
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 173} {height 388} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
